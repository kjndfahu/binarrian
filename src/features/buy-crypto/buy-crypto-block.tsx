export function BuyCryptoBlock({text, image}:{text:string, image: string}){
    return (
        <div className="flex flex-col z-[10] gap-6 w-full lg:flex-row items-center justify-between rounded-[20px] backdrop-blur-lg py-[31px] px-[45px] buy-crypto-bg border-[1px] border-[#D0DCFF8F] min-h-[120px]">
            <div className="flex flex-col sm:flex-row items-center gap-5 w-full lg:w-auto">
                ...
                <p className="text-[15px] text-white w-full 2xl:w-[762px] text-center lg:text-left break-all overflow-wrap-anywhere leading-relaxed">{text}</p>
            </div>
