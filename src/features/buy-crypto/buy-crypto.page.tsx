...
export function BuyCryptoPage() {
    return (
        <div className="flex flex-col relative overflow-x-hidden overflow-y-hidden gap-[100px]">
            <HomeHero
            ...
            <div className="flex flex-col 2xl:px-20 xl:px-16 lg:px-12 md:px-10 sm:px-8 px-6 mt-[250px] gap-[35px]">
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto0.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto1.png`}
                                text="Its API-driven solutions enable web3 platforms to onboard users to 130+ crypto assets, abstracting away the complexity of user KYC, risk monitoring & compliance, payment methods and customer support."/>
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto2.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto3.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto4.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto5.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto6.png`}
                                text="Buy crypto with a credit card, debit card, Apple Pay or Google Pay. Delivered quickly to any wallet, no hidden fees or third-party custody. Buy online or in the BitPay app."/>
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto7.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto8.png`}
                ...
                <BuyCryptoBlock image={`/img/buy-crypto/buy-crypto9.png`}
            ...
            <img className="absolute top-[350px] left-0" src="/img/elipse-light-about.png" alt="light"/>
            <img className="absolute top-[350px] scale-x-[-1] right-0" src="/img/elipse-light-about.png" alt="light"/>
            <img className="absolute h-[950px] top-[100px] z-[2] right-[-100px]" src="/img/round-light-about.png"
                 alt="light"/>
        </div>
    );
}
