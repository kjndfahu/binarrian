...
export function FaqBlock({title, text}:{title: string, text:string}){
    ...
    return (
        <div onClick={() => setIsOpen(!isOpen)} className={`flex flex-col lg:gap-[6px] gap-12 ${isOpen && ('faq-shadow')} w-full rounded-[24px] border-[1px] border-[#D0DCFF8F] p-6 faq-bg cursor-pointer`}>
