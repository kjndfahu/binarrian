    ...
    return (
        <div className="flex flex-col relative pb-[160px] overflow-x-hidden overflow-y-hidden px-20 gap-[100px]">
            ...
            <div className="flex flex-col gap-9">
                ...
                <TextBlock title="Rules and Guidelines to Report the Vulnerabilities and Get the Reward" text="Taking into account the illegal nature of unauthorized access to the computer systems, we agree not to take legal action against the researchers nor ask law enforcement bodies to investigate the cases of the security breach by the researchers in case they comply with the industry standards and responsible disclosure guidelines described in this section."/>
                <IndiceSection text={rulesText} className="whitespace-pre-line"/>
                <TextBlock text="Do not violate any law and stay in the defined scope, and do not participate in any illegal actions (activities). After sending a report, you cannot tell anyone or anywhere about the vulnerability. Public disclosure of a vulnerability makes it ineligible for a reward. Furthermore, you shall not store screenshots and/or executable codes and scripts related to the vulnerability not to make the information available to third parties."/>
            </div>
