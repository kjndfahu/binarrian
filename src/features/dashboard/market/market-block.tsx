export function MarketBlock({title, value, name, symbol, data, logo}:{title:string, value:string, name:string, symbol:string, data:number, logo: string}){
    return (
        <div className="flex flex-col h-[149px] relative w-full gap-2 border-[1px] border-[#D0DCFF8F] rounded-[12px] p-4">
            ...
            <img className="absolute right-[16px] bottom-[16px]" src="/img/btc-chart.png" alt="chart"/>
        </div>
    )
}