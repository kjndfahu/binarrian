...
export function CurrencyBlock(){
    return (
        <div>
            <div className="lg:flex hidden items-center justify-between w-full rounded-[12px] py-4 2xl:px-8 px-3 border-[1px] border-[#D0DCFF8F]">
            <div className="flex items-start 2xl:gap-4 gap-2">
                <img className="2xl:w-[44px] xl:w-[32px] w-[24px] 2xl:h-[44px] xl:h-[32px] h-[24px]" src="/img/btc-icon.svg" alt="btc"/>
            ...
            <div className="flex items-center 2xl:gap-4 gap-2">
                <div className="flex flex-col xl:px-4 px-2 gap-2">
                    <h5 className="2xl:text-[16px] xl:text-[14px] text-[12px] leading-6 font-bold text-[#CACACA]">24h Change</h5>
                ...
                <img className="xl:flex hidden 2xl:w-[86px] w-[62px] h-[28px]" src="/img/bnb-chart.svg" alt="chart"/>
            </div>
            <div className="w-[1px] bg-[#CACACA] h-full"/>
            <div className="flex flex-col xl:px-4 px-2 gap-2">
                <h5 className="2xl:text-[16px] xl:text-[14px] text-[12px] leading-6 font-bold text-[#CACACA]">Last Price</h5>
                <h3 className="2xl:text-[20px] xl:text-[17px] text-[15px] text-white font-semibold leading-[27px]">18372.595198 USD</h3>
            </div>
            <div className="w-[1px] bg-[#CACACA] h-full"/>
            <div className="flex flex-col xl:px-4 px-2 gap-2">
                <h5 className="2xl:text-[16px] xl:text-[14px] text-[12px] leading-6 font-bold text-[#CACACA]">24h Low</h5>
                <h3 className="2xl:text-[20px] xl:text-[17px] text-[15px] text-white font-semibold leading-[27px]">18372.595198 USD</h3>
            </div>
        </div>
        <CurrencyAdaptive/>
