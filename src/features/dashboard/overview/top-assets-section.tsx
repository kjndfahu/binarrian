...
export function TopAssetsSection(){
    return (
        <div
            className="relative h-[311px] lg:w-[55%] w-full rounded-[14px] border border-transparent bg-gradient-to-br from-[rgba(208,220,255,0.28)] to-[rgba(208,220,255,0.025)] p-[1px]">
            <div
                className="flex flex-col relative overflow-h-hidden bg-[#070322] gap-8 h-[311px] rounded-[12px pt-6 pb-0">
                <h3 className="lg:text-[20px] text-[18px] px-6 leading-[24px] text-white font-bold">Top Assets</h3>
