...
export function BalanceBlock() {
    return (
        <div
            className="relative lg:w-[408px] w-full rounded-[14px] border border-transparent bg-gradient-to-br from-[rgba(208,220,255,0.28)] to-[rgba(208,220,255,0.025)] p-[1px]">
            <div className="flex flex-col h-full gap-4 p-6 rounded-[12px] bg-[#070322]">
