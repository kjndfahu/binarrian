        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col">
                ...
                {sessions.map((session, index) => (
                    <div key={index}
                         className="flex items-center justify-between px-6 py-4 rounded-[12px] faq-bg bg-opacity-20 backdrop-blur-sm md:border border-[#D0DCFF8F] border-opacity-30">
                        <div className="flex-1">
                            <span className="md:text-[13px] text-[16px] text-white font-medium">{session.dateTime}</span>
                        </div>
                        <div className="flex-1 text-center">
