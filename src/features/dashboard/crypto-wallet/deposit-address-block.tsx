        ...
        <div
            ...
            <div className="flex flex-col items-center bg-[#070322] rounded-[12px] gap-5 pt-5 pb-4 px-[14px]">
                <div className="flex flex-col gap-1">
                    <h6 className="text-[12px] tracking-[1px] font-bold text-[#CACACA] leading-[13px]">ADDRESS</h6>
                    <p className="text-[10px] leading-[12px] text-[#CACACA]">Only send ETH to this address. Sending any
                ...
                <p className="font-medium text-center text-[10px] leading-[10px] text-[#CACACA]"><span className="text-[#8547F6]">Ethereum</span> deposits are available after 2 network confirmations.</p>
            </div>
        </div>
