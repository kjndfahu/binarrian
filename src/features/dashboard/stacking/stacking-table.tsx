export function StakingTable(){
    ...
    return (
        <div
            ...
            className="relative rounded-[22px] w-full overflow-x-auto xl:overflow-x-hidden border border-transparent bg-gradient-to-br from-[rgba(208,220,255,0.28)] to-[rgba(208,220,255,0.025)] p-[1px]">
            <div className="flex flex-col h-full w-full items-center justify-center gap-6">
                <div
                    className="w-full rounded-[20px] px-[30px]  bg-[#070322] overflow-hidden">
                    {/* Table Header */}
                    ...
                    <div className="flex-1 h-full overflow-y-hidden">
                        {trendAssets.map((asset, index) => (
                            <div key={index}
                                ...
                                <div className="flex-1">
                                    <span
                                        className={`${asset.isPositiveApy ? 'text-[#11CABE]' : 'text-[#FA2256]'} text-[16px] leading-6`}>{asset.estApy}</span>
                                </div>
                                <div className="flex-1">
