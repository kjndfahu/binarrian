...
export function StackingPage() {
    ...
    return (
        <div className="flex flex-col h-full overflow-y-hidden gap-8 w-full">
            ...
            <div className="flex lg:pb-0 pb-6 lg:flex-row flex-col items-start lg:px-8 md:px-5 px-4 h-full gap-6">
                <StakeBlock/>
                <StakingTable/>
            </div>
        </div>
