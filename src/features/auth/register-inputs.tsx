        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-[10px]">
                ...
                <div className="flex gap-2.5 items-center border-l border-[#d0dcff] border-opacity-50 p-[15px]">
                    <input placeholder="John Doe" className="text-[14px] outline-0 ring-0 placeholder:auth-text text-white" type="text" />
                </div>
            </div>
            ...
            <div className="flex flex-col gap-[10px]">
                ...
                <div className="flex gap-2.5 items-center border-l border-[#d0dcff] border-opacity-50 p-[15px]">
                    ...
                    <input placeholder="Create a password" className="text-[14px] outline-0 ring-0 placeholder:auth-text text-white" type="text" />
                </div>
            </div>
        </div>
    )
