...
export function HowItWorksBlock({title, text, logo}:{title: string, text: string, logo: string}){
    return (
        <div
            className="flex flex-col z-[2] how-it-works-bg h-[180px] sm:w-[374px] w-full rounded-[20px] relative gap-7 p-[26px] info-bg border-[1px] border-[#FFFFFF33] items-center justify-center">
