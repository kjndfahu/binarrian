...
export function ProjectInfo(){
    return (
        <div className="flex flex-col md:flex-row md:gap-0 sm:gap-8 gap-6 z-[1] faq-bg mt-[260px] w-full backdrop-blur-3xl py-[44px] 2xl:px-[105px] lg:px-[70px] px-5 items-center justify-between">
