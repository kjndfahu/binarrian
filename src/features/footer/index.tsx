...
export function AppFooter(){
    return (
        <div className="flex flex-col overflow-x-hidden lg:items-stretch items-center overflow-y-hidden relative gap-16 lg:pt-[150px] pt-16 lg:pb-[200px] sm:pb-[400px] pb-[200px] 2xl:px-20 xl:px-16 lg:px-12 md:px-10 sm:px-8 px-6">
            <img src="/img/logo.svg" alt="logo" className="relative z-10 w-[165px] cursor-pointer pointer-events-none select-none" />

            <div className="flex lg:flex-row flex-col lg:gap-0 gap-12 lg:items-start items-center pb-16 border-b-[1px] z-[2] border-b-[#FFFFFF1F] justify-between">
                <div className="flex flex-col lg:items-start items-center z-[2] gap-4">
                    <h3 className="text-white font-bold xl:text-[18px] text-[16px] mb-2">About Us</h3>
                    <ul className="flex flex-col lg:items-start items-center xl:text-[16px] text-[14px] gap-3">
                ...
                <div className="flex flex-col lg:items-start items-center z-[2] gap-4">
                    <h3 className="text-white font-bold xl:text-[18px] text-[16px] mb-2">Products</h3>
                    <ul className="flex flex-col lg:items-start items-center xl:text-[16px] text-[14px] gap-3">
                ...
                <div className="flex flex-col lg:items-start items-center z-[2] gap-4">
                    <h3 className="text-white font-bold xl:text-[18px] text-[16px] mb-2">Service</h3>
                    <ul className="flex flex-col lg:items-start items-center xl:text-[16px] text-[14px] gap-3">
                ...
                <div className="flex flex-col lg:items-start items-center z-[2] gap-4">
                    <h3 className="text-white font-bold xl:text-[18px] text-[16px] mb-2">Support</h3>
                    <ul className="flex flex-col lg:items-start items-center xl:text-[16px] text-[14px] gap-3">
            ...
            <p className="text-[16px] lg:mt-[-48px] z-[2] text-center text-white">Copyright © Binarrian 2025</p>

            <img
                className={`inset-0 w-[100%] lg:h-[1100px] sm:h-[2000px] h-[1800px] absolute lg:pt-[730px] sm:pt-[1700px] pt-[1660px] top-[-200px] z-[1] pointer-events-none select-none`}
                src="/img/footer-arrow.png"
                alt="arrow-down"
            />
